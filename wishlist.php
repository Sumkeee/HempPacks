            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <table class="cart-table account-table table table-bordered text-center">
                        ...
                        <tbody>
                            <?php
                            $wishsql = "SELECT p.name,p.price,p.id AS pid,w.timestamp,w.id AS id FROM wishlist w JOIN products p 
							WHERE w.pid=p.id AND w.uid='$uid' ORDER BY w.timestamp DESC";
