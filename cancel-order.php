...
<section id="content">
    <div class="content-blog">
        <div class="page-header text-center">
            ...
            <h4>Do you want to cancel Order Number <?php if (isset($_GET['id']) & !empty($_GET['id'])) {
                                                        $oid = $_GET['id'];
                                                        echo $oid;
                                                    } ?>?</h4>
        </div>
                ...
                <div class="row">
                    <div class="col-md-8 offset-md-2 table-responsive">
                        <div class="billing-details">
                            ...
                            <table class="cart-table account-table table table-bordered mt-4">
                                <thead>
                                    <tr>
                                        <th>Order</th>
                                        <th>Date</th>
                            ...
                            <input type="submit" class="button btn-lg btn-block btn-danger mt-4" value="Cancel Order">
                        </div>
                    </div>
