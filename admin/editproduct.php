    ...
    if (isset($_FILES) & !empty($_FILES)) {
        ...
        if (isset($name) & !empty($name)) {
            if (($extension == 'jpg' || $extension == 'jpeg') & $type == 'image/jpeg' & $size < $max_size) {
                ...
                echo "Only JPG failes are allowed and less then 1MB !";
            }
        } else {
        ...
        <div class="container">
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" name="productname" id="Productname" placeholder="Product Name" class="form-control" value="<?php
                                                                                                                                    echo $r['name']; ?>">
                </div>
                <div class="form-group">
                    <label for="productdescription">Product Description</label>
                    <textarea name="productdescription" rows="3" class="form-control"><?php
                                                                                        echo $r['description']; ?>"</textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="productprice" id="productprice" placeholder="Product Price" class="form-control" value="<?php
                                                                                                                                        echo $r['price']; ?>">
                </div>
